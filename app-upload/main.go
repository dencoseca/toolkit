...
func uploadOneFile(w http.ResponseWriter, r *http.Request) {
	...
	_, _ = w.Write([]byte(fmt.Sprintf("Uploaded 1 file, %s, to the uploads folder", f.OriginalFileNme)))
}
